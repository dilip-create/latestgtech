...
class DepositTransactionList extends Component
{
    ...
    public function mount()
    {
        if(Session::get('auth')->role_name == 'Merchant'){
            $this->transactionlist = DepositTransaction::where('merchant_id', Session::get('auth')->merchant_id)->select('merchant_code', 'reference_id', 'systemgenerated_TransId', 'amount', 'net_amount', 'mdr_fee_amount', 'customer_name', 'Currency', 'payment_status', 'callback_url', 'bank_account_name', 'bank_code', 'bank_account_number', 'created_at')->get();
            ...
            $this->transactionlist = DepositTransaction::where('agent_id', Session::get('auth')->agent_id)->select('merchant_code', 'reference_id', 'systemgenerated_TransId', 'amount', 'net_amount', 'mdr_fee_amount', 'customer_name', 'Currency', 'payment_status', 'callback_url', 'bank_account_name', 'bank_code', 'bank_account_number', 'created_at')->get();
            ...
            $this->transactionlist = DepositTransaction::select('merchant_code', 'reference_id', 'systemgenerated_TransId', 'amount', 'net_amount', 'mdr_fee_amount', 'customer_name', 'Currency', 'payment_status', 'callback_url', 'bank_account_name', 'bank_code', 'bank_account_number', 'created_at')->get();
