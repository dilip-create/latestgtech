                                        ...
                                        <div class="inbox-widget slimscroll" style="max-height: 324px;">
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="{{ URL::to('newassets/images/users/avatar-1.jpg') }}" class="rounded-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="{{ URL::to('newassets/images/users/avatar-2.jpg') }}" class="rounded-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="{{ URL::to('newassets/images/users/avatar-3.jpg') }}" class="rounded-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="{{ URL::to('newassets/images/users/avatar-4.jpg') }}" class="rounded-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="{{ URL::to('newassets/images/users/avatar-5.jpg') }}" class="rounded-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="{{ URL::to('newassets/images/users/avatar-6.jpg') }}" class="rounded-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="{{ URL::to('newassets/images/users/avatar-8.jpg') }}" class="rounded-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="{{ URL::to('newassets/images/users/avatar-9.jpg') }}" class="rounded-circle" alt=""></div>
