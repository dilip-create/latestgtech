                ...
                <div class="card-box">
                    <div class="card-body" id="success">
                        <div class="mb-3 p-2 border bg-v-light">
                            <ul class="list-inline right-bar-list mb-0">
                                <li class="header-title list-inline-item"><b>{{ __('messages.Total Amount:') }} <span class="text text-primary">{{ $totalAmount ?? '00' }}</span></b></li> <span class="d-none d-md-inline">|</span>
                                <li class="header-title list-inline-item"><b>{{ __('messages.Total MDR Fee:') }} <span class="text text-danger">{{ $totalmdrfee ?? '00' }}</span></b></li> <span class="d-none d-md-inline">|</span>
                                <li class="header-title list-inline-item"><b>{{ __('messages.Total Net Amount:') }} <span class="text text-success">{{ $totalNetAmount ?? '00' }}</span></b></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-2 text-end">
                            <button wire:click="exportExcel" class="btn btn-success">{{ __('messages.Export') }}</button>
                        </div>
                    </div>
